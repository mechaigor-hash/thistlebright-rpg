...
""", columns=False)
ph.text_page("More spell and gear examples", f"""
{split(
...
{card('Repeat their idea proudly', p('Child: “I give it a biscuit.” Guide: “Excellent. You offer the dragon a biscuit like a peace treaty.”'))}
