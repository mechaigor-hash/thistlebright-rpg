...
fallbacks = [
    ("01-cover.png", "Alba", "cover", ("#37264f", "#726f2d", "#132d2b")),
...
def cover():
    pages.append(f'''<section class="page full-bleed cover"><img class="bg" src="{img('01-cover.png')}" alt="Adventures in Alba cover art"><div class="scrim"></div><div class="title-panel"><h1>Adventures in Alba</h1><p>A fairy-tale tabletop RPG for brave Adventurers aged 5–7</p></div><div class="overlay"><h3>Style proof: clean restart</h3><p>Scottish fairy myth, high fantasy, simple choices, warm artwork, and print-first page design.</p></div></section>''')
...
def rules_page():
    pages.append('''<section class="page"><h2 class="section">The table rule</h2><div class="columns"><p class="drop">Adventures in Alba is played by talking together. A grown-up Guide describes a place, then each Adventurer says what their hero tries. The rules stay small so the story can stay big.</p><div class="readaloud"><strong>Read aloud:</strong> “You hear bells under the heather. A fox with silver whiskers bows and waits. What do you do?”</div><h3>When to roll</h3><p>Only roll when the answer is exciting. If an idea is safe and simple, it works. If it is tricky, roll one six-sided die.</p><table><tr><th>Roll</th><th>What happens</th></tr><tr><td>1–2</td><td>A wobble: something funny or inconvenient happens.</td></tr><tr><td>3–4</td><td>A yes, but: success with a tiny cost or choice.</td></tr><tr><td>5–6</td><td>A bright success: the hero does it well.</td></tr></table><div class="rulebox"><strong>Kindness rule:</strong> heroes can be scared, surprised, muddy, or silly, but the story never punishes an Adventurer for trying to help.</div><h3>The five stats</h3><ul><li><strong>Strength</strong> for lifting, holding, and protecting.</li><li><strong>Wis</strong> for noticing, comforting, and understanding.</li><li><strong>Agility</strong> for sneaking, catching, and balancing. Add <strong>Int</strong> for puzzles and <strong>Luck</strong> for fairy chances.</li></ul></div><div class="page-number">3</div></section>''')
...
def sheet():
    pages.append('''<section class="page"><h2 class="section">Character sheet style</h2><p>This sheet is deliberately large, printable, and chunky. A five-year-old should be able to point at each box and explain it.</p><div class="sheet"><div class="box"><strong>Hero name</strong></div><div class="box"><strong>Player name</strong></div><div class="box"><strong>Kindred</strong></div><div class="box"><strong>Adventure job</strong></div><div class="box"><strong>Strength</strong><br>+__</div><div class="box"><strong>Int / Wis</strong><br>+__ / +__</div><div class="box"><strong>Agility / Luck</strong><br>+__ / +__</div><div class="box"><strong>Treasure</strong></div><div class="box big"><strong>Draw your hero</strong></div><div class="box big"><strong>My helper question</strong><br><br>When I am stuck, I can ask...</div></div><div class="page-number">10</div></section>''')

cover(); opener(); rules_page(); step_pages(); bestiary(); sheet()
HTML = '<!doctype html><html><head><meta charset="utf-8"><title>Adventures in Alba Style Proof</title><style>'+CSS+'</style></head><body><main class="book">' + '\n'.join(pages) + '</main></body></html>'
